...
The normLibSizes function normalizes the library sizes in such a way to minimize the log-fold changes between the samples for most genes. The default method for computing these scale factors uses a trimmed mean of M-values (TMM) between each pair of samples [41]. We call the product of the original library size and the scaling factor the effective library size, i.e., the normalized library size. The effective library size replaces the original library size in all downsteam analyses.
...
Watch **[this](https://www.youtube.com/watch?time_continue=441&v=lJw6Ku_jQkM&embeds_referring_euri=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3DNegative%2Bbinomial%2Bmodels%2Brnaseq%26sca_esv%3D598740777%26sxsrf%3DACQVn091hnV__QsRaEFJg8f9UZDK_WCcjg%253A170&source_ve_path=MjM4NTE&feature=emb_title).**  
